...
class StringUtil extends Util
{
     ...
     */
    public static function inflect($string, $delimeter = null, $ignore = null)
    {
    ...
    public static function humanize($string, $ignore = null)
    {
        ...
        return ucwords(strtolower(self::inflect($string, ' ', $ignore)));
    }
    ...
    public static function dasherize($string, $ignore = null)
    {
        ...
        return self::inflect($string, '-', $ignore);
    }
    ...
    public static function underscorize($string, $ignore = null)
    {
        ...
        return self::inflect($string, '_', $ignore);
    }
